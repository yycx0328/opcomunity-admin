...
namespace BackStage.Data
{
    ...
    /// 数据库初始化
    /// </summary>
    internal sealed class Configuration : DbMigrationsConfiguration<BackStageContext>
    {
        ...
        protected override void Seed(BackStageContext context)
        {
            #region 用户
            ...
            var admin = new UserEntity
            {
                LoginName = "luyunhai",
                RealName = "超级管理员",
                Password = "yycx0328".ToMD5(),
                Email = "lyh_oracle@hotmail.com",
                Status = 2,
                CreateDateTime = now
            };
            var guest = new UserEntity
            {
                LoginName = "liumeng",
                RealName = "游客",
                Password = "tom548636".ToMD5(),
                Email = "liumeng@opcomunity.com",
                Status = 2,
                CreateDateTime = now
            };
            //用户
